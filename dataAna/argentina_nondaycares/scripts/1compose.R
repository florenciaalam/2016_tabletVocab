...
read.xlsx("data/Prueba_tableta_datos.xlsx",1,startRow=3)->nsb
read.xlsx("data/Prueba_tableta_datos.xlsx",2,startRow=3)->nsm
names(nsb)[c(3,6)]<-c("id","dob")
names(nsm)[c(3,6)]<-c("id","dob")
rbind(nsm[,c(3,6)],nsb[,c(3,6)])->dobs
...
resdob$school=ifelse(resdob$school=="cayetano","Low","Mid")
